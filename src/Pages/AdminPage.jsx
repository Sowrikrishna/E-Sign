...
export const AdminPage = () => {
    ...
    const sidebarLinks = [
        { name: "Dashboard", path: "/admin_page", icon: dashboardicon },
        { name: "Overview", path: "/admin_page/View_Sign", icon: overviewicon },
            ...
            <div className='flex'>
                <div className="md:w-64 w-16 border-r h-[550px] text-base border-gray-300 pt-4 flex flex-col transition-all duration-300">
                    {sidebarLinks.map((item, index) => (
                        <NavLink href={item.path} key={item.name} end={item.path=="/admin_page"}
